...
class RunnerTest(unittest.TestCase):
    ...
    def test_construction_ok(self):
        ...
        self.assertIs(self.files, data_tree.reach(self.files_key % 'plan'),
    ...
    def test_run_plan_ok(self):
        ...
        self.assertEquals('bar', runner.data.reach('a_map.foo'), 'Run loads data')
        self.assertEquals([], runner.data.reach('datafaser.run.plan'), 'Run empties plan')
        self.assertEquals(self.files, runner.data.reach(self.files_key % 'done'), 'Run done load')
